...
# From: https://gist.github.com/jcouture/546572fb39b0084fb22c
...
Pod::Spec.new do |s|
  ...
  s.source = { :git => 'https://github.com/cantinac/XMPPFramework.git', :tag => s.version.to_s }
  s.resources = [ '**/XMPPRoster.xcdatamodel', '**/XMPPCapabilities.xcdatamodel', '**/*.xcdatamodeld']
